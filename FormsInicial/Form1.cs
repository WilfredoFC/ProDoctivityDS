...
namespace ProdoctivityPdfProcessor
{
    public partial class Form1 : Form
    {
        ...
        private string BearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..yuQl8gXIemkdDMXrGeHiWZCC7iyBXL4XmkrBvp1nPAE";
        ...
        private void CreateSearchTab()
        {
            ...
            var tableLayout = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 1, RowCount = 3, Padding = new Padding(5) };
            tab.Controls.Add(tableLayout);

            // Criteria panel
            var criteriaPanel = new GroupBox { Text = "Criterios de Búsqueda", Dock = DockStyle.Fill, Height = 180, AutoSize = true };
            var criteriaLayout = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 4, RowCount = 5, Padding = new Padding(10) };
            ...
            lblSearchCount = new Label { Text = "0 documentos encontrados", Font = new Font("Arial", 9, FontStyle.Bold), Anchor = AnchorStyles.Right };
            ...
            var selectionPanel = new FlowLayoutPanel { Dock = DockStyle.Fill, FlowDirection = FlowDirection.LeftToRight, Padding = new Padding(0, 5, 0, 0) };
            ...
            lblSelectedCount = new Label { Text = "0 seleccionados", Font = new Font("Arial", 9, FontStyle.Bold), ForeColor = Color.DodgerBlue, AutoSize = true, Margin = new Padding(20, 0, 0, 0) };
            ...
            tableLayout.SetRowSpan(resultsPanel, 2);
        ...
        private void CreateProcessingTab()
        {
            ...
            var layout = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 1, Padding = new Padding(5), AutoSize = true };
            tab.Controls.Add(layout);

            // API config
            var apiGroup = new GroupBox { Text = "🔧 Configuración API", Dock = DockStyle.Fill, AutoSize = true };
            var apiLayout = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 3, RowCount = 5, Padding = new Padding(10) };
            ...
            // Options
            var optionsGroup = new GroupBox { Text = "⚙️ Opciones de Procesamiento", Dock = DockStyle.Fill, AutoSize = true };
            var optionsLayout = new FlowLayoutPanel { Dock = DockStyle.Fill, FlowDirection = FlowDirection.LeftToRight, Padding = new Padding(10), WrapContents = false };
            ...
            // Status
            var statusGroup = new GroupBox { Text = "📊 Estado del Proceso", Dock = DockStyle.Fill, AutoSize = true };
            var statusLayout = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 10, RowCount = 3, Padding = new Padding(10) };
            ...
            // Buttons
            var buttonPanel = new FlowLayoutPanel { Dock = DockStyle.Fill, FlowDirection = FlowDirection.LeftToRight, Padding = new Padding(0, 10, 0, 0) };
        ...
        private void CreateAnalysisTab()
        {
            ...
            var layout = new FlowLayoutPanel { Dock = DockStyle.Fill, FlowDirection = FlowDirection.TopDown, Padding = new Padding(10), AutoScroll = true };

            var criteriaGroup = new GroupBox { Text = "🔎 Criterios para Remover Primera Página", AutoSize = true, Width = 900 };
            var criteriaLayout = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 3, RowCount = 6, Padding = new Padding(10) };
            ...
            var normLayout = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 2, RowCount = 4, Padding = new Padding(10) };
            ...
            var infoGroup = new GroupBox { Text = "ℹ️ Información sobre la Normalización de Texto", AutoSize = true, Width = 900 };
...
Esto permite detectar patrones incluso cuando el formato varía.",
        ...
        private (bool shouldRemove, string diagnosis) AnalyzeFirstPageContent(byte[] pdfBytes)
        {
            try
            {
                ...
                using var pdf = PdfPigDoc.Open(stream);   // ← Usamos alias PdfPigDoc
        ...
        private byte[] RemovePdfFirstPage(byte[] pdfBytes)
        {
            try
            {
                ...
                using var document = PdfReader.Open(inputStream, PdfDocumentOpenMode.Modify); // ← PdfSharpDoc (PdfSharp.Pdf.PdfDocument)
        ...
        private void StopProcessing(object sender, EventArgs e)
        {
            ...
            // Leer los contadores actuales desde las etiquetas
                    ...
                    for (int j = 0; j < binaries.Count; j++)
                    {
                        ...
                        if (binaryStr.StartsWith("data:"))
                        {
                            ...
                            if (mime.ToLower().Contains("pdf"))
                            {
                                ...
                                // Update page count in grid (usando PdfPigDoc para leer el PDF resultante)
                                try
                                {
